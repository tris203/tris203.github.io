...
export default function HomePage() {
  ...
  return (
    <div className='pt=12 flex h-full flex-col bg-linear-to-tr from-black to-gray-700 pt-24 md:h-screen'>
          ...
          <div className='flex h-full w-full flex-col rounded-lg border-4 border-gray-700 bg-gray-800 p-6 transition duration-500 ease-in-out hover:-translate-y-1 hover:scale-105  hover:bg-gray-700'>
            ...
            <div className='mt-2 text-sm text-gray-100'>
              <Link href='/blog'>
                <button
                  type='button'
                  className='rounded-sm bg-gray-700 px-4 py-2 font-bold text-gray-100 hover:bg-gray-600'
                >
                  View All Posts
                </button>
              </Link>
